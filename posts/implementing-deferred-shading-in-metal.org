...
#+MACRO: POST_TITLE Implementing Deferred Shading in Metal
...
algorithm can be found [[http://ogldev.atspace.co.uk/www/tutorial37/tutorial37.html][here]]).
...
- Download the [[https://developer.apple.com/library/content/samplecode/AdoptingMetalI/AdoptingMetalIApracticalapproachtoyourfirstMetalapp.zip][sample code]] (I started with the sample code from [[https://developer.apple.com/library/content/samplecode/AdoptingMetalI/Introduction/Intro.html][Apple's Adopting Metal I]] sample).
...
program in hand: [[https://github.com/sevanspowell/MetalDeferredLightingTutorial][MetalDeferredLightingTutorial]].
...
[[file:../img/posts/implementing-deferred-shading-in-metal/albedo.png]]
...
[[file:../img/posts/implementing-deferred-shading-in-metal/normal.png]]
...
[[file:../img/posts/implementing-deferred-shading-in-metal/position.png]]
...
[[file:../img/posts/implementing-deferred-shading-in-metal/lights-normal.png]]
...
[[file:../img/posts/implementing-deferred-shading-in-metal/lights-albedo.png]]
...
[[file:../img/posts/implementing-deferred-shading-in-metal/lights-sphere.png]]
...
[[http://ogldev.atspace.co.uk/www/tutorial36/tutorial36.html][this]] OGLDev tutorial.
...
[[file:../img/posts/implementing-deferred-shading-in-metal/lights-colour-albedo.png]]

And another with no texture, so that you can see the lights better:

[[file:../img/posts/implementing-deferred-shading-in-metal/lights-colour-flat.png]]

*** An aside on gamma correction
Gamma correction, it's really important:

@@html: <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://www.youtube.com/embed/LKnqECcg6Gw' frameborder='0' allowfullscreen></iframe></div>@@

Further reading:

- [[http://http.developer.nvidia.com/GPUGems3/gpugems3_ch24.html][GPU Gems 3: The Importance of Being Linear]]
- [[http://www.codinglabs.net/article_gamma_vs_linear.aspx][Coding Labs: Gamma and Linear Spaces]]
- [[http://www.gamasutra.com/blogs/DavidRosen/20100204/4322/GammaCorrect_Lighting.php][Gamasutra: Gamma-Correct Lighting]]
...
* Related links
  - [[http://ogldev.atspace.co.uk/www/tutorial35/tutorial35.html][OGLDev - Deferred Shading Part 1]]
  - [[https://learnopengl.com/#!Advanced-Lighting/Deferred-Shading][Learn OpenGL - Deferred Shading]]
  - [[http://www.codinglabs.net/tutorial_simple_def_rendering.aspx][Coding Labs - Deferred Rendering]]
