...
Theory see [[*References][1]] and [[*References][2]], but essentially Category Theory is a field concerned
...
[[*References][1]] [[*References][2]], but I'm not knowledgeable enough to be so thorough, hopefully this
